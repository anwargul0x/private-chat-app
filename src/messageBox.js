...
render(){
    ...
    <div className="message-box ">
            <div className="messages" onChange={this.scroller}>&nbsp;
               <ul> {this.props.chatMessages.map((message, index) => { return (<div className={`msg-container-${this.props.chatClasses[index]}`}><li className={this.props.chatClasses[index]} key={index}>{message}</li></div>) })}<br /></ul></div>
